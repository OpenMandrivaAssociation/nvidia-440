...
%define __requires_exclude_from libnvidia-encode.so.%version|libnvidia-opticalflow.so.%version
...
# mv %{buildroot}%{_sysconfdir}/vulkan/icd.d/nvidia_icd.json %{buildroot}%{_sysconfdir}/vulkan/icd.d/nvidia_icd.json
